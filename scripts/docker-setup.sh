...
echo "   docker-compose run --rm transcriber python3 transcriber.py -i /app/input/your_video.mp4 -m /opt/whisper.cpp/models/ggml-base.bin -o /app/output/transcript.txt"
echo ""
...
echo ""
echo "📚 For more help:"
echo "   docker-compose run --rm transcriber python3 transcriber.py --help" 