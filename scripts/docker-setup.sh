...
echo "   docker-compose run --rm transcriber python3 -m src.transcriber -i /app/input/your_video.mp4 -m /opt/whisper.cpp/models/ggml-base.bin -o /app/output/transcript.txt"
echo ""
